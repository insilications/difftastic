...
pub(crate) fn guess_content(bytes: &[u8]) -> ProbableFileKind {
    ...
    if !saw_malformed {
        let num_null = utf16_string.chars().take(5000).filter(|c| *c == '\0').count();
        if num_null <= 1 {
...
fn relative_file_paths_in_dir(dir: &Path) -> Vec<PathBuf> {
    ...
    let walker = WalkBuilder::new(dir)
        ...
        .filter_entry(|e| !(e.file_type().map(|ft| ft.is_dir()).unwrap_or(false) && e.file_name() == ".git"))
        .build();
...
pub(crate) fn relative_paths_in_either(lhs_dir: &Path, rhs_dir: &Path) -> Vec<PathBuf> {
    ...
    paths.extend(lhs_paths[i..].iter().filter(|&path| !seen.contains(path)).cloned());
    paths.extend(rhs_paths[j..].iter().filter(|&path| !seen.contains(path)).cloned());
...
mod tests {
    ...
    fn test_gzip_is_binary() {
        ...
        let bytes = vec![
            0x1f, 0x8b, 0x08, 0x00, 0x3a, 0xb0, 0x91, 0x63, 0x00, 0x03, 0x8b, 0x8e, 0xe5, 0x02, 0x00, 0x44, 0xd2, 0x68,
            0x70, 0x03, 0x00, 0x00, 0x00,
        ];
    ...
    fn test_dex_is_binary() {
        let bytes = vec![
            0x34, 0x8a, 0x4b, 0x8f, 0x77, 0xa4, 0x4e, 0xb1, 0x31, 0x2d, 0x5f, 0xfb, 0x10, 0x08, 0xa8, 0x6b, 0x58, 0x06,
            0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x78, 0x56, 0x34, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xac, 0x05, 0x00, 0x00, 0x23, 0x00, 0x00, 0x00, 0x70, 0x00, 0x00, 0x00,
        ];
    ...
    fn test_png_bytes_are_binary() {
        let bytes = vec![
            ...
            ,
        ];
        assert_eq!(guess_content(&bytes), ProbableFileKind::Binary);
    }
}
